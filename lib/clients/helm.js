...
class Helm {
  ...
  async _installCertManager() { https://github.com/jetstack/cert-manager/releases/download/v0.16.0/cert-manager.yaml
    await this.kubectl.cmd('apply --validate=false -f https://raw.githubusercontent.com/jetstack/cert-manager/v0.16.0/deploy/crds/crd-clusterissuers.yamlhttps://raw.githubusercontent.com/jetstack/cert-manager/v0.13.0/deploy/manifests/00-crds.yaml');
